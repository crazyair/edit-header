...
const Options = () => {
    ...
    const [urlPatterns, setUrlPatterns] = useStorage('urlPatterns', ['<all_urls>']);
        ...
        <div style={{ padding: '20px', maxWidth: '600px' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
                ...
                {headers.map((header, index) => (
                    <div key={index} style={{ display: 'flex', gap: '10px', margin: '10px 0' }}>
                        <input
                            type="text"
            ...
            <div style={{ marginBottom: '20px' }}>
                ...
                />
                <p style={{ fontSize: '12px', color: '#666' }}>默认为 &lt;all_urls&gt;（所有链接）</p>
            </div>

            <button onClick={saveConfig} style={{ padding: '10px 20px', fontSize: '16px' }}>
                保存配置
            </button>
